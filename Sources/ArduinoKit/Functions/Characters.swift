...
@inlinable
@inline(__always)
public func isAlpha(_ character: UInt8) -> Bool {
...
@inlinable
@inline(__always)
public func isAlphaNumeric(_ character: UInt8) -> Bool {
...
@inlinable
@inline(__always)
public func isAscii(_ character: UInt8) -> Bool {
...
@inlinable
@inline(__always)
public func isControl(_ character: UInt8) -> Bool {
...
@inlinable
@inline(__always)
public func isDigit(_ character: UInt8) -> Bool {
...
@inlinable
@inline(__always)
public func isGraph(_ character: UInt8) -> Bool {
    return isPrintable(character) && isWhitespace(character)
}
...
@inlinable
@inline(__always)
public func isHexadecimalDigit(_ character: UInt8) -> Bool {
...
@inlinable
@inline(__always)
public func isLowerCase(_ character: UInt8) -> Bool {
...
@inlinable
@inline(__always)
public func isPrintable(_ character: UInt8) -> Bool {
...
@inlinable
@inline(__always)
public func isPunct(_ character: UInt8) -> Bool {
    if character < 0x21 || character > 0x7E { return false } // Outside printable ASCII
    if isAlphaNumeric(character) { return false } // Alphanumeric
...
public func isSpace(_ character: UInt8) -> Bool {
...
@inlinable
@inline(__always)
public func isUpperCase(_ character: UInt8) -> Bool {
...
@inlinable
@inline(__always)
public func isWhitespace(_ character: UInt8) -> Bool {
